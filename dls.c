...
GtkWidget *or_button, *darea, *pack_box;
...
static void not_dis(GtkWidget *widget, gpointer data){
        ...
        gtk_box_pack_start(GTK_BOX(pack_box), image, TRUE, TRUE , 0);
...
//	gtk_drag_source_set(and_box, GDK_BUTTON1_MASK, tar, 1, GDK_ACTION_MOVE);		//	connect it to all source signals	//
